...
{
	xr_vector<COperatorCondition>::iterator I = lower_bound(m_conditions.begin(), m_conditions.end(), condition);
...
{
	xr_vector<COperatorCondition>::iterator I = lower_bound(m_conditions.begin(), m_conditions.end(), COperatorCondition(condition, COperatorCondition::_value_type(0)));
...
{
	xr_vector<COperatorCondition>::const_iterator I = lower_bound(conditions().begin(), conditions().end(), COperatorCondition(condition, COperatorCondition::_value_type(0)));
