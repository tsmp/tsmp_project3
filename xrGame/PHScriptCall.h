...
class CPHScriptCondition : public CPHCondition,
...
class CPHScriptAction : public CPHAction,
						public CPHReqComparerV
{
	bool b_obsolete;
...
class CPHScriptObjectCondition : public CPHCondition,
								 public CPHReqComparerV
{
...
class CPHScriptObjectAction : public CPHAction,
							  public CPHReqComparerV
{
	bool b_obsolete;
	luabind::object *m_lua_object;
...
class CPHScriptObjectConditionN : public CPHCondition,
								  public CPHReqComparerV
{
...
class CPHScriptObjectActionN : public CPHAction,
							   public CPHReqComparerV
{
	bool b_obsolete;
...
public:
	CPHScriptGameObjectAction(const luabind::object &object, const luabind::functor<void> &functor, CObject *gobj) : CPHScriptObjectActionN(object, functor)
	{
		m_obj = gobj;
	}
	virtual bool compare(const CPHReqComparerV *v) const { return v->compare(this); }
