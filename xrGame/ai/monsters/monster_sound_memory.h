...
typedef struct tagSoundElement
{
	...
	IC void SetConvert(const CObject *whoParam, int eType, const Fvector &positionParam, float powerParam, TTime timeParam)
	{
		who = whoParam;
		type = ConvertSoundType(static_cast<ESoundTypes>(eType));
