...
void CAI_Stalker::can_kill_entity(const Fvector &position, const Fvector &direction, float distance, collide::rq_results &rqStorage)
{
	...
	Level().ObjectSpace.RayQuery(rqStorage, ray_defs, ray_query_callback, &params, NULL, this);
