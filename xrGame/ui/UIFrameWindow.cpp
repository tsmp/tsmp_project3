...
void CUIFrameWindow::FrameClip(const Frect parentAbsR)
{
	...
	if (max(ourAbsR.right, parentAbsR.left) == parentAbsR.left || min(ourAbsR.left, parentAbsR.right) == parentAbsR.right || min(ourAbsR.top, parentAbsR.bottom) == parentAbsR.bottom || max(ourAbsR.bottom, parentAbsR.top) == parentAbsR.top)
	{
