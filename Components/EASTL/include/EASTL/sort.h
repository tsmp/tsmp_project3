...
namespace eastl
{
	...
	inline void bubble_sort(ForwardIterator first, ForwardIterator last, StrictWeakOrdering compare)
	{
		...
		eastl::Internal::bubble_sort_impl<ForwardIterator, StrictWeakOrdering>(first, last, compare, ITC());
	}
	...
	inline void bubble_sort(ForwardIterator first, ForwardIterator last)
	{
		...
		eastl::Internal::bubble_sort_impl<ForwardIterator, Less>(first, last, Less(), ITC());
	}
