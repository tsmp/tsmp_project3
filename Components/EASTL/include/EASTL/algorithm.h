...
namespace eastl
{
	...
	move_n(InputIterator first, Size n, OutputIterator result)
	{
		...
		return eastl::move_n_impl(first, n, result, ITC());
	}
	...
	{
		typedef typename eastl::iterator_traits<InputIterator>::iterator_category ITC;
		return eastl::copy_n_impl(first, n, result, ITC());
	}
	...
	*/
	...
	{
		typedef typename eastl::iterator_traits<BidirectionalIterator>::iterator_category ITC;
		eastl::reverse_impl(first, last, ITC());
	}
	...
	search_n(ForwardIterator first, ForwardIterator last, Size count, const T& value)
	{
		...
		return eastl::search_n_impl(first, last, count, value, ITC());
	}
	...
	ForwardIterator rotate(ForwardIterator first, ForwardIterator middle, ForwardIterator last)
	{
		if(middle != first)
		{
			if(middle != last)
			{
				...
				return Internal::rotate_helper<ITC, eastl::is_trivially_copyable<value_type>::value>::rotate_impl(first, middle, last);
			}
