...
namespace eastl
{
	...
	{
		typedef typename eastl::iterator_traits<ForwardIterator>::iterator_category ITC;
		...
		return Internal::uninitialized_relocate_impl<bHasTrivialMove, ITC>::do_move_start(first, last, dest);
	}
	...
	EASTL_REMOVE_AT_2024_APRIL inline ForwardIteratorDest uninitialized_relocate_commit(ForwardIterator first, ForwardIterator last, ForwardIteratorDest dest)
	{
		...
		return Internal::uninitialized_relocate_impl<bHasTrivialMove, ITC>::do_move_commit(first, last, dest);
	}
	...
	EASTL_REMOVE_AT_2024_APRIL inline ForwardIteratorDest uninitialized_relocate_abort(ForwardIterator first, ForwardIterator last, ForwardIteratorDest dest)
	{
		...
		return Internal::uninitialized_relocate_impl<bHasTrivialMove, ITC>::do_move_abort(first, last, dest);
	}
	...
	{
		typedef typename eastl::iterator_traits<InputIterator>::iterator_category ITC;
		return Internal::uninitialized_copy_n_impl<InputIterator, Count, ForwardIterator, ITC>::impl(first, n, dest);
	}
