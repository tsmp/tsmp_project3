...
// TSMP: todo раскомментировать или удалить ненужное
...
public:
	...
	virtual bool PickBone(const Fmatrix& parent_xform, Fvector& normal, float& dist, const Fvector& start, const Fvector& dir, u16 bone_id) = 0;
	...
	virtual u16 LL_GetBoneRoot() const = 0;
